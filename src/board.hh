...
struct Move {
    ...
    bool isCastled = false, isDouble = false, isEp = false;
...
public:
    ...
    uint64_t rookAttack(int sq, uint64_t blocker) const;
    uint64_t bishopAttack(int sq, uint64_t blocker) const;
    uint64_t queenAttack(int sq, uint64_t blocker) const;
    Position copy() const;
